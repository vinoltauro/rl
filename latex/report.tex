...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{figures/gridworld_training.pdf}
...
\begin{subfigure}[b]{0.55\linewidth}
  \includegraphics[width=\linewidth]{figures/cartpole_all_algorithms.pdf}
...
\begin{subfigure}[b]{0.42\linewidth}
  \includegraphics[width=\linewidth]{figures/cartpole_sample_efficiency.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{figures/mountaincar_comparison.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{figures/dqn_overestimation.pdf}
\caption{Q-value overestimation in standard vs.\ Double DQN. \textit{Left}: Huber loss on symlog scale — standard DQN loss diverges to 2,491; Double DQN stabilises at $\sim$700. \textit{Right}: corresponding performance — standard DQN plateaus at $-134$, Double DQN achieves $-146.7$ without runaway.}
...
\centering
\begin{subfigure}[b]{0.55\linewidth}
  \includegraphics[width=\linewidth]{figures/ppo_comparison.pdf}
...
\hfill
\begin{subfigure}[b]{0.42\linewidth}
  \includegraphics[width=\linewidth]{figures/ppo_entropy_comparison.pdf}
